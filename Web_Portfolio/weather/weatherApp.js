...
function ask()  {
	...
	.then(data =>{
		...
		$('#temperature-desription').attr('textContent', data.weather[0].description);
		temperatureDegree.textContent = data.main.temp;
		//temperatureDescription.textContent = data.weather[0].description;
		locationTimezone.textContent = data.timezone+" "+data.name+", "+data.sys.country;
		pressureDescription.textContent = data.main.pressure+" Kpa";
